...
/**
  *
  * 这一段是对JDBC操作的一些封装主要是运用的反射机制对返回的实体类对象进行装载
  * 而增删改和原本的操作实际上是一致的主要是进行了封装
  *
  * 写太多了.....很多都是不需要的...推荐大家不要自己去写这些代码...
  * 如果你也想写的话可以直接copy这个工具类,当然这个工具类也存在许多的缺陷
  *
  * @data 2018/5/20 8:43
  * @by wjl
*/
public class JdbcUtil {
        ...
        private static  String driverClassName="com.mysql.jdbc.Dirver";
        ...
        private static ResultSetMetaData prepareRsmd(String sql, List<Object> params)
                throws SQLException {
